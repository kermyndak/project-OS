...
disk_format:
	...
	$(LD) -m elf_i386 -T link.ld -o kernel $(BOOTOBJ)kasm.o $(TEMPFUNCTIONSOBJ)temp.o $(KERNELOBJ)kc0-1.o $(KERNELOBJ)interrupts.o $(KERNELOBJ)isr.o $(KERNELOBJ)irq.o $(KERNELOBJ)idt.o --oformat binary
